...
import pandas as pd
# PAAD_glmGCN
# train_ [0.9908257, 0.9816513, 0.9818182, 0.98181814, 0.9818182, 0.9818182, 0.98181814, 0.9818182, 0.9818182, 0.9863637]
# test_ [0.73076916, 0.8076922, 0.74999994, 0.9166666, 0.74999994, 0.83333325, 0.8333333, 0.875, 0.6666666, 0.8333332]
# train_ 0.9831568 test_ 0.7996794
# specificity 0.851923076923077 sensitivity 0.7474358974358976  f1_score 0.7880858272162621 auc 0.8551380157440763
# 
# PAAD_glmGCN_1
# train_ [0.9908257, 0.9816514, 0.9818182, 0.98181814, 0.9818182, 0.98636365, 0.98636365, 0.9818182, 0.9818182, 0.9818182]
# test_ [0.73076916, 0.7692307, 0.74999994, 0.95833325, 0.74999994, 0.875, 0.8333333, 0.8333333, 0.6666666, 0.8333332]
# train_ 0.9836114 test_ 0.7999999
# specificity 0.851923076923077 sensitivity 0.7480769230769231  f1_score 0.787308300395257 auc 0.8519474072504375
# PAAD_glmGCN
# train_ [0.9908257, 0.9816514, 0.9818182, 0.98181814, 0.9818182, 0.98636365, 0.98181814, 0.98636365, 0.9818182, 0.9818182]
# test_ [0.73076916, 0.8076922, 0.74999994, 0.95833325, 0.74999994, 0.875, 0.74999994, 0.74999994, 0.6666666, 0.8333332]
# train_ 0.9836114 test_ 0.7871794
# specificity 0.826923076923077 sensitivity 0.7474358974358974  f1_score 0.7776903820816865 auc 0.8498396945366642
...
flags.DEFINE_float('lr2', 0.0001, 'Initial GCN learning rate.')
...
flags.DEFINE_float('losslr2',0.001, 'xxxx')
flags.DEFINE_float('losslr3',0.001,'xxxx')
...
data=pd.read_csv('input_PAAD.csv')
...
# A=A+I
ppi_matrix = np.load("ppi_PAAD.npy")
...
for train,test in KF.split(x,y):
    ...
    placeholders = {
        ...
        'features': tf.sparse_placeholder(tf.float32, shape=tf.constant([features[2][0],features[2][1]], dtype=tf.int64)),
    ...
    # # # Initialize session
    os.environ["CUDA_VISIBLE_DEVICES"] = '2'   # Specifies which GPU is available
    ...
    save_path = saver.save(sess, "PAAD_MODEL/model" + str(count1))
